...
import de.htwberlin.webtech.gamingBud.gaming.api.service.PersonService;
...
public class PersonRestController {
    ...
    public ResponseEntity<List<Person>> fetchPersons() { return ResponseEntity.ok(personService.findAll());}
